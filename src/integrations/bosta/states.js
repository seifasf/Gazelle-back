...
export const DEFAULT_STATE_TO_INTERNAL = {
  ...
  [BOSTA_STATE.TERMINATED]: 'returned_awaiting_receipt',
  [BOSTA_STATE.CANCELED]: 'returned_awaiting_receipt',
  [BOSTA_STATE.RETURNED_TO_STOCK]: 'returned_awaiting_receipt',
  ...
  RETURNED_TO_BUSINESS: 'returned_awaiting_receipt',
  TERMINATED: 'returned_awaiting_receipt',
  EXCEPTION: 'failed_delivery',
  'Returned to business': 'returned_awaiting_receipt',
  Terminated: 'returned_awaiting_receipt',
  Delivered: 'delivered',
